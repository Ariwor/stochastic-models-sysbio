...
% In this case though, k_1=-1 and as a result there is negative feedback.
% k_0 has been changed accordingly to ensure that the steady-state protein mean
% has the same value with the case with positive feedback (k_0=+1)

function dydt = first_moment_covariance_matrix_neg(t,y)
k_0=17;
k_1=-1;
k_p=5;
g_r=10;
