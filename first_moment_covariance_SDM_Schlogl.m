...
% Separable Derivative Matching(SDM) is used to "close" the moment equations.

function dydt = first_moment_covariance_SDM_Schlogl(t,y,V)
 ...
 S_111 = ((y(3) + y(1)^(2))^(3))/(y(1)^(3)) - (3*y(1)*y(3) + y(1)^(3));
